...
export default function Profile() {
  ...
  return (
    <AccountShell title={t('profile.title')} subtitle={t('profile.subtitle')}>
      <motion.div
      ...
      >
        <section className="bg-white p-8 rounded-3xl border border-brand-100 shadow-card">
          ...
          <div className="space-y-5">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-caption text-brand-600">{t('profile.emailLabel')}</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-caption text-brand-600">{t('profile.memberSince')}</p>
        ...
        <section className="bg-navy-950 text-white p-8 rounded-3xl shadow-elevated relative overflow-hidden">
          ...
          <div className="relative z-10 p-5 rounded-2xl bg-white/5 border border-white/10">
            ...
            >
              {t('profile.setAddressAtCheckout')}
            </button>
          </div>
        </section>
      </motion.div>
