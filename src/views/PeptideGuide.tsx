...
import { howToJsonLd } from '../seo/structuredData';
    ...
    <div className="bg-white min-h-screen pt-12 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <motion.div
          ...
          className="bg-brand-50 border-l-4 border-brand-500 p-6 rounded-r-2xl mb-12 text-left max-w-3xl mx-auto shadow-sm"
        >
