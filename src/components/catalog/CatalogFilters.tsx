...
function FiltersPanel({
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-eyebrow-accent text-brand-600 before:bg-brand-500 mb-4">{t('filters.categories')}</h3>
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-eyebrow-accent text-brand-600 before:bg-brand-500">{t('filters.maxPrice')}</h3>
...
export function CatalogFilters(props: CatalogFiltersProps) {
  ...
  if (mode === 'trigger') {
    return (
      <button
        ...
        className="lg:hidden inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-steel-600 shadow-card hover:border-brand-500/40 transition-colors"
  ...
  if (mode === 'sidebar') {
    return (
      ...
      >
        <GlassPanel variant="light" padding="md" className="space-y-6 border-t-4 border-t-brand-500/40">
